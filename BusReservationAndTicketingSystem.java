...
public class BusReservationAndTicketingSystem {
    ...
    for(int i=1;i<4;){
    	...
    	if(user.equals("devarsya") && password.equals("379")){
    		for(int x=1; x==1;){
    			//the MAIN MENU//
    			System.out.println("********************************************");
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)Manjalpur | 000600 |   "+available[1]+"   **");
    					System.out.println("** 2.)waghodia  | 000170 |   "+available[2]+"   **");
    					System.out.println("** 3.)fatehgunj | 000150 |   "+available[3]+"   **");
    					System.out.println("** 4.)taneja    | 000200 |   "+available[4]+"   **");
    					System.out.println("** 5.)jambuva   | 000250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
    					System.out.println("STUDENT, & SENIOR CITIZEN with 25% DISCOUNT!!!\n");	
    					x=0;
					}
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
    					System.out.println("PWD, STUDENT, & SENIOR CITIZEN with 25% DISCOUNT!!!\n");
    					...
    					String dest[] = { " ", "Manjalpur", "waghodia", "fatehgunj", "taneja", "jambuva"};
    					...
    					if(print==1){
    						...
    						System.out.println("***************************************\n");
    						ticketS[z][2]="0";
    						double discount=(ticketD[z][0]-(ticketD[z][0]*0.25))*ticketI[z][1];
